...
public:
	...
	void ShowExplosionAndStartAgain( const std::set<Core::CPlayer>& collidedPlayers, const std::set<Core::CPlayer>& crashedPlayers ) const;
	void ShowExplosionAndDie( const std::set<Core::CPlayer>& collidedPlayers, const std::set<Core::CPlayer>& crashedPlayers ) const;
